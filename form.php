        ...
        <div class="row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                            <div class="custom-control custom-radio custom-control-inline">
                                ...
                                <label for="produk_0" class="custom-control-label">CELANA STONE ISLAND</label>
                            </div>
                            <div class="custom-control custom-radio custom-control-inline">
                                <input name="produk" id="produk_1" type="radio" class="custom-control-input" value="BAJU" required="required"> 
                                <label for="produk_1" class="custom-control-label">BAJU STONE ISLAND</label>
                            </div>
                            <div class="custom-control custom-radio custom-control-inline">
                                <input name="produk" id="produk_2" type="radio" class="custom-control-input" value="SHOES" required="required"> 
                                <label for="produk_2" class="custom-control-label">SHOES ADIDAS SAMBA</label>
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
            ...
            <div class="col-md-6">
                <div class="harga-list">
                    <h4>Daftar Harga :</h4>
                    <ul>
                        <li>CELANA STONE ISLAND- Rp. 4.200.000</li>
                        <li>BAJU STONE ISLAND- Rp. 3.100.000</li>
                        <li>SHOES ADIDAS SAMBA- Rp. 3.800.000</li>
                    </ul>
                </div>
            </div>
        </div>
